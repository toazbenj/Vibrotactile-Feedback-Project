...
Created on Wed Jan 26 13:46:37 2022
@author: Ben Toaz
"""
...
def submit_registered_with_option(key, alt_key,scale_option,rotation_option):
...
initialize()
register("Circle", "Circle.tact")
submit_registered_with_option("Circle", "alt",
